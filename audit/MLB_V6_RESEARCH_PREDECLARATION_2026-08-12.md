...
This amendment is part of the pre-fit V6 context protocol. It does not alter or relabel the already-frozen NRFI V6 or Pitcher BB V6 forward-shadow candidates. No V6 GAME context artifact or V6 GAME context holdout result existed when it was added to the reconciliation branch.

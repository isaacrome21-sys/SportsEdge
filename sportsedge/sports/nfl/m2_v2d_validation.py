"""Walk-forward diagnostic evidence for the NFL M2 V2D structured-mean candidate."""
...
_KEY_PROFILE_CONTRACT = "NFL_M2_V2D_CANDIDATE_OOS_SIGNED_KEY_PMF_V1"
...
def build_nfl_m2_v2d_raw_evaluations(
    ...
    *,
    ...
    for fold in folds:
        model = fit_nfl_m2_v2d_candidate(
            fold.train_rows,
...
def _key_profile(evaluations: Iterable[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "probability_source": "OOS_STRUCTURED_MEAN_TRAINING_EMPIRICAL_INTEGER_SCORE_SUPPORT",
...
def build_nfl_m2_v2d_candidate_evidence(
    ...
    *,
    ...
    raw = build_nfl_m2_v2d_raw_evaluations(
        rows,
    ...
    return {
        ...
        "diagnostic_question": (
            "Does a structured market-blind mean representation plus observed integer NFL score "
            "support improve untouched-fold spread/total evidence and emergent signed 3/7 mass "
            "without changing frozen gates or using market inputs in model fitting?"
        ),
    }

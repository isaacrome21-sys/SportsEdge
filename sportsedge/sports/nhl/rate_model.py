...
def _linear_rate(team, opponent, opponent_goalie, p: NHLRateParameters, *, home: bool) -> float:
    ...
    eta = (
        p.intercept + p.offense_xg * team.xgf_per_60 + p.opponent_xga * opponent.xga_per_60
    ...
    # log-link keeps expected goals positive; cap only prevents pathological config overflow.

...
def build_canonical_feature_row(*,game:LiveGame,quote:Mapping[str,Any],source:MLBGenericHistorySource,target_date:date)->dict[str,Any]:
    ...
    if market in HITTER_MARKETS:
        ...
        return {**base,"team_id":team_id,"opposing_pitcher_id":opposing_pitcher_id,"venue_id":venue_id,"joint_feature_version":built["feature_version"],"feature_source_hash":built["feature_source_hash"],"features":{"history_pool":built["history_pool"],"history_weights":built["history_weights"],"matchup":built["matchup"]}}

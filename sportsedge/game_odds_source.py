...
Acquires DraftKings h2h, spreads, and totals and binds every provider event to
exactly one MLB StatsAPI game before emitting SportsEdge quotes. This module is
price acquisition only: sportsbook prices never become Model_P.
"""

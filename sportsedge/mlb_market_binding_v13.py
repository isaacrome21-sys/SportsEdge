...
class MarketBinding:
    ...
    def __post_init__(self) -> None:
        ...
        if self.threshold_domain not in {THRESHOLD_DOMAIN_NONE, THRESHOLD_DOMAIN_NON_NEGATIVE, THRESHOLD_DOMAIN_RUN_LINE}:
...
def _side(v):
    raw=str(v).upper(); return _SIDE_ALIASES.get(raw,raw)

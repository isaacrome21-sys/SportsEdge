...
def test_reconciliation_advances_through_pr840_in_first_parent_order() -> None:
    registry = json.loads(Path('config/freeze_reconciliation_registry_v1.json').read_text())

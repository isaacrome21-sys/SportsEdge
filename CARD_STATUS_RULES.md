...
5. **TRIAL**: real engine Model_P, blocked only by NOT_PROMOTED, edge at least 3.0% vs paired no-vig at the logged price, row has book, price, retrieved_at, and model artifact SHA.
...
- BLOCKED: Model_P missing, any data/venue/quote/devig blocker, a promoted market with no frozen edge floor, or unpromoted with no qualifying TRIAL. List every reason.
